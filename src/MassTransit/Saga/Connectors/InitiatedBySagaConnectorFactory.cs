namespace MassTransit.Saga.Connectors
{
    ...
    public class InitiatedByAndOrchestratesSagaConnectorFactory<TSaga, TMessage> :
        ISagaConnectorFactory
        ...
        where TMessage : class, CorrelatedBy<Guid>
    {
        ...
        public InitiatedByAndOrchestratesSagaConnectorFactory()
        {
            var consumeFilter = new InitiatedByAndOrchestratesSagaMessageFilter<TSaga, TMessage>();
